...
public class PlayerData
{
    ...
    public void SetGlobals()
    {
        ...
        GameData.redBestScore = redBestScore;
        ScoreSystemManager.MaxRedScore = redBestScore;
        GameData.whiteBestScore = whiteBestScore;
        ScoreSystemManager.MaxWhiteScore = whiteBestScore;
        GameData.plataletBestScore = plataletBestScore;
        ScoreSystemManager.MaxPlataletScore = plataletBestScore;
    }
}
